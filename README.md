...
pixi add aiida aiida-core aiida-core.atomic_tools aiida-core.notebook aiida-core.rest aiida-core.services
# for installing globally
pixi global install aiida aiida-core aiida-core.atomic_tools aiida-core.notebook aiida-core.rest aiida-core.services
```
...
It is possible to list all of the versions of `aiida` available on your platform:
...
```
pixi search aiida --channel conda-forge
```
